...
|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| Оценка руководителя — ключевой фактор удовлетворенности          | 1. Пересмотреть систему оценки сотрудников.  
2. Ввести KPI для руководителей, связанные с удовлетворённостью персонала. |
| Длительный стаж коррелирует с большей удовлетворённостью         | 1. Ввести менторские программы.  
2. Организовать поддержку для новых сотрудников.                        |
| Зарплата влияет слабо                                            | 1. Внедрить нематериальные методы мотивации.  
2. Создать программы признания заслуг.                                |
...
|----------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------------|
| Демография увольнений            | 51% junior-специалистов увольняются; стаж 1–3 года; низкая загрузка    | 1. Программы адаптации и менторства  
2. Карьерные треки для junior-сотрудников |
| Оценка руководителя              | Уволившиеся получают оценки ниже на 16%                                | 1. Обучение руководителей  
2. Учет удовлетворенности команды в KPI                             |
| Зарплата и мотивация             | Зарплата уволившихся на 37% ниже; нет связи с загрузкой               | 1. Провести анализ рыночных зарплат  
2. Ввести бонусы за стаж и эффективность             |
| Загрузка сотрудников             | Низкая загрузка → 45% увольнений                                       | 1. Оптимизация распределения задач  
2. Система кросс-функциональных проектов           |
| Отдел HR                         | Самый высокий процент оттока (45%)                                     | 1. Программа нематериальной мотивации  
2. Ротация функций внутри отдела HR             |
